...
func main() {
	...
	http.HandleFunc("/blog/post/", helper.Handle(blog.InsertBlogWithRelationView))
	...
	http.HandleFunc("/reviews/anime/", helper.Handle(review.GetAnimeReviewsWithUserInfoView))
